  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="relative w-full h-[100svh] flex flex-col overflow-hidden bg-[#111111]">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col items-center pb-8 sm:pb-12 px-2 sm:px-4 translate-y-[30px] sm:translate-y-[42px]">
          <motion.div
            className="w-full max-w-[98vw] sm:max-w-5xl md:max-w-6xl aspect-[5.6/1] bg-[#f6c45a] drop-shadow-[0_6px_24px_rgba(0,0,0,0.95)]"
            style={{
      ...
      <section className="bg-[#f6c45a] w-full px-4 md:px-8 py-20 md:py-32 flex flex-col justify-center border-y-8 border-[#111111]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 w-full">
          <ScrollReveal className="flex-1 w-full text-center lg:text-left" direction="left">
            <p className="font-sans text-xl md:text-2xl font-bold uppercase tracking-[0.3em] mb-4 text-[#111111]/60">LATEST DROP</p>
      ...
      <section className="bg-[#cf5d27] w-full px-4 md:px-8 py-20 md:py-32 flex flex-col justify-center">
        <ScrollReveal className="w-full text-center mb-16">
          <h2 className="text-[15vw] leading-none text-[#111111]">WORK</h2>
          <h2 className="text-[15vw] leading-none text-[#f6c45a] -mt-12">OFFERINGS</h2>
        </ScrollReveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 w-full">
          {[
            { tag: "DJing", title: "SOUND CURATION", bg: "#111111", color: "#f6c45a", sub: "#efe7d7" },
            { tag: "DESIGN", title: "VISUAL SYSTEMS", bg: "#f6c45a", color: "#cf5d27", sub: "#111111" },
            { tag: "BRAND", title: "STRATEGY + COLLAB", bg: "#445829", color: "#f6c45a", sub: "#d9decf" },
          ].map((c, i) => (
            <ScrollReveal key={c.tag} delay={i * 0.1}>
              <div className="p-12 md:p-16 text-center" style={{ backgroundColor: c.bg }}>
                <h3 className="font-display text-6xl md:text-8xl mb-4" style={{ color: c.color }}>{c.tag}</h3>
                <p className="font-sans text-xl font-bold uppercase tracking-wider" style={{ color: c.sub }}>{c.title}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
      ...
      <section className="bg-[#445829] w-full px-4 md:px-8 py-20 md:py-32 flex flex-col justify-center">
        <div className="flex flex-col lg:flex-row items-center gap-12 w-full">
          ...
          <ScrollReveal className="flex-1 w-full text-center lg:text-right" direction="right">
            ...
            <h2 className="text-[10vw] leading-none text-[#111111] mb-12">EVENTS</h2>
      ...
      <section className="bg-[#efe7d7] w-full px-4 md:px-8 py-20 md:py-32 flex flex-col justify-center overflow-hidden border-t-8 border-[#111111]">
        <ScrollReveal>
          <h2 className="text-massive text-center text-[#445829] mb-12">PORTFOLIO</h2>
        </ScrollReveal>
        <ScrollReveal className="w-full relative hover-img">
          <img src={artE} alt="Art" className="w-full object-cover max-h-[80vh]" />
