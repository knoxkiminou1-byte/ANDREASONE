...
import { BOOKING_EMAIL } from "@/data/siteLinks";
  ...
  return (
    <div className="w-full flex flex-col">
      <section className="bg-black poster-panel border-b-8 border-[#cf5d27] text-center">
        <ScrollReveal>
          <h1 className="text-[15vw] leading-none text-[#f6c45a]">ENTER</h1>
        </ScrollReveal>
        <ScrollReveal delay={0.07}>
          <h1 className="text-[12vw] leading-none text-[#cf5d27]">THE WORLD</h1>
        </ScrollReveal>
        <ScrollReveal delay={0.14}>
          <p className="font-sans text-xl md:text-2xl uppercase tracking-[0.25em] text-[#efe7d7]/50 mt-8 max-w-2xl mx-auto">
            Bookings, collaborations, partnerships, and signals.
          </p>
        </ScrollReveal>
      </section>
        ...
        <ScrollReveal className="w-full max-w-5xl bg-[#efe7d7] border-8 border-[#111111] shadow-[24px_24px_0_#f6c45a] p-12 md:p-24">
          {sent ? (
            <div className="text-center py-16">
              <h2 className="font-display text-[8vw] text-[#445829] leading-none mb-8">SIGNAL<br />RECEIVED</h2>
              <p className="font-sans text-2xl font-bold uppercase tracking-wide text-[#111111] mb-12">
                We'll be in touch. Serious signals only — and you clearly are.
              </p>
              <Button
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="text-center lg:text-left">
                  <h2 className="font-display text-[8vw] md:text-[6vw] text-[#cf5d27] leading-none mb-8">CONNECT</h2>
                  <p className="font-sans text-2xl font-bold uppercase mb-12 text-[#111111]">
                    For DJ bookings, creative direction, brand partnerships, and collaborations. Serious inquiries only.
                  </p>
                  <div className="space-y-6 text-[#445829]">
                    <div>
                      <h3 className="font-display text-3xl">MANAGEMENT</h3>
                      <a href={`mailto:${BOOKING_EMAIL}`} className="font-sans text-xl font-bold uppercase hover:text-[#cf5d27] transition-colors cursor-pointer">
                        {BOOKING_EMAIL}
                      </a>
                    </div>
                    <div>
