...
const pieces = [
  { src: art01, title: "GUITAR HANDS",     series: "Sound Made Visible", year: "2024" },
  { src: art04, title: "BLESSING",         series: "Hand Studies",        year: "2024" },
  { src: art05, title: "ALL-SEEING HAND",  series: "Hand Studies",        year: "2024" },
  { src: art07, title: "EYE OF THE SUN",   series: "Symbology",           year: "2024" },
  { src: art13, title: "AFRO REPOSE",      series: "Figures",             year: "2025" },
  { src: art16, title: "WOMAN WITH FRUIT", series: "Figures",             year: "2025" },
  { src: art03, title: "MOON SIT",         series: "Figures",             year: "2025" },
  { src: art09, title: "GOLDEN HOUR",      series: "Figures",             year: "2025" },
  { src: art12, title: "SUN HAT",          series: "Figures",             year: "2025" },
  { src: art10, title: "BEACH SUN",        series: "Figures",             year: "2025" },
  { src: art02, title: "STACKED FORMS I",  series: "Cubist Studies",      year: "2025" },
  { src: art15, title: "STACKED FORMS II", series: "Cubist Studies",      year: "2025" },
  { src: art06, title: "SWING A LING",     series: "Soundsystems",        year: "2024" },
  { src: art08, title: "DESERT VISION",    series: "Landscapes",          year: "2024" },
  { src: art11, title: "BALI MORNING",     series: "Landscapes",          year: "2025" },
  { src: art14, title: "ROOFLINE",         series: "Landscapes",          year: "2024" },
  { src: art17, title: "FAVELA SUN",       series: "Landscapes",          year: "2025" },
];
    ...
    <div className="w-full flex flex-col">
      <section className="bg-sage poster-panel border-b-8 border-[#111111] text-center">
        ...
        <ScrollReveal delay={0.07}>
          <h1 className="text-[18vw] stacked-title-word text-[#111111] -mt-3 md:-mt-8">WORK</h1>
        </ScrollReveal>
      </section>
